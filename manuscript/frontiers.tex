...
\begin{figure}
	\centering
    \includegraphics[width=0.85\textwidth]{tmg-example.jpg}
...
% \subsubsection{Summary parameters of SPM} \label{sss:discrete_spm_params}
% To complement the SPM $ t $-continuum generated from each SPM paired $ t $-test (see Figure~\ref{fig:spm_example} for an example), we also provide the following discrete parameters to make the SPM result easier to compare at a glance.
% \begin{itemize}
...
\begin{figure}
	\centering
    \includegraphics[width=0.6\textwidth]{example_result_by_subj_by_set.jpg}
...
\begin{figure}
	\centering
    \includegraphics[width=0.6\textwidth]{example_result_by_subj_across_sets.jpg}
