...
However, fatigue can coexist with PAP [18], and the measured muscular performance represents the net balance between processes that cause the fatigue and processes that cause potentiation [18].
PAP has been demonstrated using electrically induced twitch contractions and attributed to phosphorylation of myosin regulatory light chains [21], making actin and myosin more sensitive to \ce{Ca^2+} [2].
...
TP is a well-established and reproducible phenomenon that manifests as enhanced twitch amplitude [19][27][28] and decreased time to maximum amplitude [4][20][21].  % TODO phrase better
